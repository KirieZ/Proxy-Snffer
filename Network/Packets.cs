...
namespace RappelzSniffer.Network
{
	public class Packets
	{
		...
		public static Dictionary<short, Packet> LoadGamePackets()
		{
			...
			packets_db.Add(0x0001, new Packet() { func = GamePackets.TS_LOGIN });
			...
			packets_db.Add(0x0004, new Packet() { func = GamePackets.TS_LOGIN_RESULT });
            ...
            packets_db.Add(0x0032, new Packet() { func = GamePackets.TS_CS_VERSION });
			...
			packets_db.Add(0x00CA, new Packet() { func = GamePackets.TS_WEAR_INFO });
			packets_db.Add(0x00CF, new Packet() { func = GamePackets.TS_SC_INVENTORY });

			packets_db.Add(0x00D8, new Packet() { func = GamePackets.TS_SC_BELT_SLOT_INFO });
			...
			packets_db.Add(0x01F4, new Packet() { func = GamePackets.TS_SC_STATUS_CHANGE });
			packets_db.Add(0x01FB, new Packet() { func = GamePackets.TS_SC_PROPERTY });
			...
			packets_db.Add(0x0258, new Packet() { func = GamePackets.TS_SC_QUEST_LIST });
			...
			packets_db.Add(0x0385, new Packet() { func = GamePackets.TS_SC_CHANGE_LOCATION });
			packets_db.Add(0x0386, new Packet() { func = GamePackets.TS_SC_WEATHER_INFO });

			packets_db.Add(0x03E8, new Packet() { func = GamePackets.TS_SC_STAT_INFO });
			packets_db.Add(0x03E9, new Packet() { func = GamePackets.TS_SC_GOLD_UPDATE });
			packets_db.Add(0x03EA, new Packet() { func = GamePackets.TS_SC_LEVEL_UPDATE });
			packets_db.Add(0x03EB, new Packet() { func = GamePackets.TS_SC_EXP_UPDATE });

			packets_db.Add(0x044C, new Packet() { func = GamePackets.parse_44C });
			packets_db.Add(0x044D, new Packet() { func = GamePackets.TS_SC_GAME_TIME });

			packets_db.Add(0x07D1, new Packet() { func = GamePackets.TS_CS_CHARACTER_LIST });
			packets_db.Add(0x07D2, new Packet() { func = GamePackets.TS_CS_CREATE_CHARACTER });
			packets_db.Add(0x07D3, new Packet() { func = GamePackets.TS_CS_DELETE_CHARACTER });
			packets_db.Add(0x07D4, new Packet() { func = GamePackets.TS_SC_CHARACTER_LIST });
			packets_db.Add(0x07D5, new Packet() { func = GamePackets.TS_CS_ACCOUNT_WITH_AUTH });
			packets_db.Add(0x07D6, new Packet() { func = GamePackets.TS_CS_CHECK_CHARACTER_NAME });
			...
			packets_db.Add(0x2328, new Packet() { func = GamePackets.TS_SC_OPEN_URL });
			packets_db.Add(0x2329, new Packet() { func = GamePackets.TS_SC_URL_LIST });

            packets_db.Add(0x232C, new Packet() { func = GamePackets.TS_SC_REQUEST_SECURITY_NO });
            packets_db.Add(0x232D, new Packet() { func = GamePackets.TS_CS_SECURITY_NO });
